...
╠══〘 *INFORMACIÓN DEL BOT* 〙 ══ 🌸
╠
╠➥ [😸] Creadora del Bot: JHONM
╠➥ [😼] Nombre del Bot: WOLFBOT
╠➥ [#️⃣] Número: https://wa.me/message/W6GFE5ERA6U4I1
...
╠══════〘 bot v3〙 ═════ 🌸
`.trim() 
  conn.fakeReply(m.chat, info, '0@s.whatsapp.net', '*🐈 𝘿𝙞𝙤𝙨 🐈*', 'status@broadcast')
}
